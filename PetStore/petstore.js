...
function calculateFoodOrder(numAnimals, avgFood) {
    ...
    if (animals != NaN && food != NaN && numAnimals >= 0 && avgFood >= 0) {
...
function isValid(names, types, breeds) {
    return names && types && breeds &&
    Array.isArray(names) && Array.isArray(types) && Array.isArray(breeds) &&
